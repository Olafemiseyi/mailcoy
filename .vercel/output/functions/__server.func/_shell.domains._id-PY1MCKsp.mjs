...
//#region node_modules/.nitro/vite/services/ssr/assets/_shell.domains._id-PY1MCKsp.js
...
var SplitErrorComponent = ({ error, reset }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
			...
			children: "Unable to load domain"
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "text-[13px] text-ink-3 mb-4",
			children: friendlyError(error, "Failed to load domain details.")
		}),
