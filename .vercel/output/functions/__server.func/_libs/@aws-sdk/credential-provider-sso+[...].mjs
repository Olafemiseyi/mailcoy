...
import { C as require_schema, S as require_client$1, _ as require_protocols, b as require_endpoints, c as require_httpAuthSchemes, g as require_retry, h as require_dist_cjs, i as init_dist_es, m as require_client, n as require_protocols$1, r as dist_es_exports$1, v as require_checksum, x as require_config, y as require_serde } from "./client-ses+[...].mjs";
...
var getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
	const { SSOOIDCClient } = await import("./nested-clients+[...].mjs").then((n) => /* @__PURE__ */ __toESM(n.n()));
...
var getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
	const { CreateTokenCommand } = await import("./nested-clients+[...].mjs").then((n) => /* @__PURE__ */ __toESM(n.n()));
