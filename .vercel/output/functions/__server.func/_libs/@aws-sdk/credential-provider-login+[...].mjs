...
import { _ as require_protocols, m as require_client, x as require_config } from "./client-ses+[...].mjs";
...
var LoginCredentialsFetcher = class LoginCredentialsFetcher {
	...
	async refresh(token) {
		const { SigninClient, CreateOAuth2TokenCommand } = await import("./nested-clients+[...].mjs").then((n) => /* @__PURE__ */ __toESM(n.r()));
