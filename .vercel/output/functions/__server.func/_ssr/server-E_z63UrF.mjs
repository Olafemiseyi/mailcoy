...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-Czkc-MeI.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-JmA2WHA2.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-YNsLelXf.mjs"),
		import("./start-C-kNShze.mjs"),
