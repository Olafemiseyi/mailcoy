...
//#region node_modules/.nitro/vite/services/ssr/assets/status-BM9yzsRc.js
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							...
							onClick: async () => {
								...
								try {
									const { searchGlobalEmailLogs } = await import("./admin.functions-Bhxi-PnD.mjs").then((n) => n.t).then((n) => n.t);
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: async () => {
									const { setPlatformBroadcast } = await import("./admin.functions-Bhxi-PnD.mjs").then((n) => n.t).then((n) => n.t);
