...
import { t as opts } from "./organizations-CUNj1pzo.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/organizations--x1gaNYC.js
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
											...
											onClick: async () => {
												...
												if (!sel) return;
												try {
													const { overrideOrgPlan } = await import("./admin.functions-UZyOER8E.mjs").then((n) => n.t).then((n) => n.t);
