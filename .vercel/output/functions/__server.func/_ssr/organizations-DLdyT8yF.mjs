...
import { t as opts } from "./organizations-DS71nUkS.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/organizations-DLdyT8yF.js
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
											...
											onClick: async () => {
												...
												if (!sel) return;
												try {
													const { overrideOrgPlan } = await import("./admin.functions-CvrArqa1.mjs").then((n) => n.t).then((n) => n.t);
