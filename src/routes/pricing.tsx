    ...
    >
      ...
      <div className="flex justify-center mb-8">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-line bg-surface text-[12.5px] text-ink-3 shadow-xs">
          ...
          <span>
            Prices auto-formatted in <strong className="text-ink">{currency === "NGN" ? "NGN (₦)" : "USD ($)"}</strong> based on your region
          </span>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {plans.map((p) => (
          ...
          >
            ...
            <div className="mt-4 flex flex-wrap items-baseline gap-1.5 whitespace-nowrap">
