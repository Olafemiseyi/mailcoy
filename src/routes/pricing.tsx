  ...
  const plans = [
    {
      ...
      ngnAnnual: 0,
      features: [
        "1 employee business email",
        "1 verified custom domain",
        "50 monthly emails (inbound + outbound)",
        "Native Gmail Send-As bridge",
        "Plain text email signature",
        "7-day message log history",
      ],
      highlight: false,
    ...
    },
    {
      name: "Starter Pro",
      tag: "Small Teams",
      desc: "Ideal for boutique agencies, consultants, and early-stage teams.",
      usdMonthly: 9,
      usdAnnual: 7,
      ngnMonthly: 7500,
      ngnAnnual: 6000,
      ...
      features: [
        ...
        "1 verified custom domain",
        "2,000 monthly emails (150/day max)",
        "Max 2 aliases per employee (10 total)",
        "Branded HTML signatures with logo",
        "Up to 10 reusable email templates",
        "10 MB attachment limit",
        "30-day message logs history",
      ],
      highlight: false,
    ...
    },
    {
      ...
      features: [
        ...
        "10,000 monthly emails (500/day max)",
        "Up to 5 aliases per employee (30 total)",
        "Catch-all routing & smart rules",
        "25 MB attachment limit",
        "90-day message telemetry logs",
