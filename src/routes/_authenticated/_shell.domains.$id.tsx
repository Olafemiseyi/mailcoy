  ...
  const recommendedRecords = [
    {
      ...
      type: "TXT",
      host: "@",
      value: d.spf_value ?? "v=spf1 include:amazonses.com ~all",
      priority: null,
      status: d.spf_status,
        ...
        {activeTab === "required" && (
          <div className="mx-4 sm:mx-5 mt-4 p-3 rounded-lg border border-blue-500/20 bg-blue-500/[0.04] text-[12.5px] text-ink-2">
            ...
            <p className="text-[12px] text-ink-3 leading-relaxed">
              ...
              <code className="font-mono text-ink">inbound-smtp.us-east-1.amazonaws.com</code>, and{" "}
              <strong>Priority</strong>:{" "}
              <code className="font-mono font-bold text-blue-700 dark:text-blue-400">10</code> (then
              repeat for <code>inbound-smtp.us-east-1.amazonaws.com</code> with Priority{" "}
            ...
            <div className="space-y-3 text-[13px]">
              ...
              <div className="p-3.5 rounded-xl border border-line bg-surface/60 space-y-1.5">
                ...
                <p className="text-ink-3 text-[12px] pl-7">
                  ...
                  <code className="font-mono text-[11px]">inbound-smtp.us-east-1.amazonaws.com</code>, Priority:{" "}
                  <strong className="text-blue-600 dark:text-blue-400 font-mono font-bold">
                    10
                  </strong>
                  . Save, then repeat for{" "}
                  <code className="font-mono text-[11px]">inbound-smtp.us-east-1.amazonaws.com</code> with Priority{" "}
                  <strong className="text-blue-600 dark:text-blue-400 font-mono font-bold">
                    20
                  </strong>
                  .
            ...
            <div className="space-y-3 text-[13px]">
              ...
              <div className="p-3.5 rounded-xl border border-line bg-surface/60 space-y-1.5">
                ...
                <p className="text-ink-3 text-[12px] pl-7">
                  ...
                  <strong>@</strong>, Value: <strong>inbound-smtp.us-east-1.amazonaws.com</strong>, Priority:{" "}
            ...
            <div className="space-y-3 text-[13px]">
              ...
              <div className="p-3.5 rounded-xl border border-line bg-surface/60 space-y-1.5">
                ...
                <p className="text-ink-3 text-[12px] pl-7">
                  ...
                  <code className="font-mono">inbound-smtp.us-east-1.amazonaws.com</code> (Priority: 10).
                </p>
              </div>
            </div>
          )}
